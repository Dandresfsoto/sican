...
urlpatterns = [
    ...
    url(r'^contratacion/contratos/formadores/$', views.ContratosFormadoresView.as_view()),
    url(r'^contratacion/contratos/formadores/editar/(?P<id_formador>[0-9]+)/$', views.ContratoFormadorView.as_view()),
    url(r'^contratacion/contratos/formadores/editar/(?P<id_formador>[0-9]+)/nuevo/$', views.NuevoContratoFormadorView.as_view()),
    url(r'^contratacion/contratos/formadores/editar/(?P<id_formador>[0-9]+)/editar/(?P<id_contrato>[0-9]+)/$', views.UpdateContratoFormadorView.as_view()),
