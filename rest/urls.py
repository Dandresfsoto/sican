...
from rest.views import AdministrativosRhSoportes, AdminUserList, GroupUserList
...
urlpatterns = [
    ...
    url(r'admin/usuarios/$', AdminUserList.as_view()),
    url(r'admin/grupos/$', GroupUserList.as_view()),
